...
export class CalculadoraComponent implements OnInit {
  ...
  //faz a instanciação do calculadoraserivice para ser utilizaod em toda class.
   ...
   * Caso já possua um operação selecionada,
  ...
  definirOperacao(operacao: string): void {
    //apenas define a opercao caso não exista uma
    if (this.operacao === null) {
