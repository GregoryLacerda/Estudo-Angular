...
export class JogoDaVelhaService {
  ...
  jogar(posX: number, posY: number): void {
    ...
    //faz a jogada da maquina caso não tenha terminado o jogo ainda
   ...
   */
   cpuJogar(): void{
    ...
    if (jogada.length <= 0) {
      //tenta jogara para evitar derrota
  ...
  /**
   * Retorna se a peça x deve ser axibida para a
  ...
  /**
   * Retorna se a peça O deve ser axibida para a
   * coordenada informada.
   * 
   * @param posX 
   * @param posY 
  ...
  /**
   * Retorna se a maracação de vitória deve ser exibida para a
   * coordenada informada.
   * 
   * @param number posX 
   * @param number posY 
